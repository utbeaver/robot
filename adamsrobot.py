...
pns=pns+[(_3pts[1][0]+conR*np.cos(i), _3pts[1][1]+conR*np.sin(i)) for i in np.radians(np.linspace(alpha1*0, beta1+90,10))]
...
lm11=SliderMechanismLean(model, "SLM11", dl, dr, L, L, R, disk1_mar, 90-alpha1, 0, 89.99, _motion=_motion[0])
...
brace2SPDP=Marker(rotBase, "brace2SPDP",  (0, 0, -2*T/2-T/2), ref=braceFR)
...
Lnk2ToBrace=Marker(ParaLnk12, "Lnk2ToBrace", pos, (0, 0, angleAlignedFromLevel)) 
...
freelen=ll-effDist
print freelen
SPDPT(model, "Spring111", firstPmar1, braceFU, 18*2, 0, 0, freelen)  
...
Link(firstPlate, "plate", 2*T, T, firstPmar1, firstPmar3)
...
#freelen=L+dl-dr
#print freelen
#freelen=np.sqrt(ll*ll+effDist*effDist)
#print freelen
#SPDPT(model, "Spring112", firstPmar1_90, braceBL, 22, 0, 0, freelen)  
firstPmar3_90=Marker(firstPlate90, "firstPmar3_90", (-(effDist)*np.cos(alpha2*d2r), (effDist)*np.sin(alpha2*d2r), 0), ref=firstPmar1_90)
Link(firstPlate90, "plate", T, T, firstPmar1_90, firstPmar2_90)
Lnk2ToPlate90_=Marker(ParaLnk12, "Lnk2ToPlate90_", (ll, 0, T+T/2), (0,0,0), ref=Lnk2ToBrace)
Joint(model, "paraLink2_Plate90", Lnk2ToPlate90_, firstPmar2_90)
#
#
ParaMar3J=Marker(firstPlate, "toLink3J", (0, 0, -T/2+T/4), ref=firstPmar3)
ParaLnk13=Part(model, "ParaLnk13")
ParaLnk13MarI=Marker(ParaLnk13, "toLink3I", (0, effDist, -T/2+T/4), (0,0,angleAlignedFromLevel+angleFromAbligned), ref=firstPmar1)#Vertical)
...
sndPmar2=sndPmar3
Cylinder(secondPlate, "Cyn", T, R+T, Marker(secondPlate, "cynMar", (0,0,-R+T*2), ref=sndPmar2))
Link(secondPlate, "plate", T, T, sndPmar1, sndPmar3)
...
freelen=L-effDist
firstPmar2=Marker(firstPlate, "firstPmar2", (0, effDist/2*2, 0), ref=firstPmar1)
SPDPT(model, "Spring121", firstPmar2, sndPmar3, 7, 0, 0, freelen)  
...
secPmar3_90_pair=Marker(secPlate90, "secPmar3_90_pair", (0,0,0), ( 0,0,(90-angleAlignedFromLevel-angleFromAbligned)), ref=ParaLnk14J)
secPmar3_90_pairJ=Marker(secPlate90, "secPmar3_90_pairJ", (-effDist,0,0), ref=secPmar3_90_pair)
secPmar2_90=Marker(secPlate90, "secPmar2_90", (-effDist*(1-gr), 0, 0), (180,0, 0), ref=secPmar3_90_pair)

Link(secPlate90, "link", T, T, secPmar3_90_pair, secPmar3_90_pairJ)
...
sndPmar1For2ndSlider=Marker(secondPlate, "sndPmar1For2ndSlider", (0,effDist*gr,0),(0,0,alpha3),  ref=sndPmar2For2ndSlider)
disk2_mar=Marker(secondPlate, "disk2_cen_mar", (0,0,-(T+halfsize*0)),  ref=sndPmar2For2ndSlider)

lm12=SliderMechanismLean(model, "SLM12", dl*gr, dr*gr, L*gr, L*gr, R*gr, disk2_mar, 0, 0, 89.99, _motion=_motion[1])
#lm12=SliderMechanismLean(model, "SLM12", dl*gr, dr*gr, L, L, R*gr, disk2_mar, 90-alpha3, 45, 89.9, _motion=_motion[1])
#
...
dxyz3=(ll1*np.cos(angleAlignedLine2*d2r), ll1*np.sin(angleAlignedLine2*d2r), 0)
ParaLnk21Mar2=Marker(ParaLnk21, "ParaLnk21Mar2", dxyz3, ref=ParaLnk21Mar1)
...
TrdPmar2=Marker(TrdPlate, "TrdPmar2", (0, effDist*gr, 0), ref=TrdPmar1)
TrdPmar3=Marker(TrdPlate, "TrdPmar3", (-(effDist*gr)*np.cos(alpha4*d2r), (effDist*gr)*np.sin(alpha4*d2r),  0), ref=TrdPmar1)
TrdPmar3=TrdPmar2
#Plate(TrdPlate, "plate", T, T, (TrdPmar1, TrdPmar2, TrdPmar3))
Link(TrdPlate, "link", T, T, TrdPmar1, TrdPmar2)
...
freelen=(L-effDist)*gr
SPDPT(model, "Spring211", TrdPmar1, sndPmar1For2ndSlider, 15, 0, 0, freelen)  
SPDPT(model, "Spring221", lm12.distalmarFront, ParaLnk21Mar2, 7, 0, 0, freelen)  
#
...
TrdPmar2_90=Marker(TrdPlate90, "TrdPmar2_90", (0, effDist*gr, 0), ref=TrdPmar1_90)
TrdPmar3_90=Marker(TrdPlate90, "TrdPmar3_90", (-(effDist*gr)*np.cos(alpha4*d2r), (effDist*gr)*np.sin(alpha4*d2r),  0), ref=TrdPmar1_90)
TrdPmar3_90=TrdPmar2_90
Link(TrdPlate90, "plate90", T, T, TrdPmar1_90, TrdPmar2_90)
#
#
ParaLnk22=Part(model, "ParaLnk22")
ParaLnk22Mar1=Marker(ParaLnk22, "ParaLnk22Mar1",  ref=secPmar2_90)
ParaLnk22Mar2=Marker(ParaLnk22, "ParaLnk22Mar2", dxyz3, ref=ParaLnk22Mar1)
Link(ParaLnk22, "link", T, T, ParaLnk22Mar1, ParaLnk22Mar2)
Joint(model, "Paralnk22_secPlate", ParaLnk22Mar1, Marker(secPlate90, "secplate_toParaLnk22", ref=secPmar2_90))
Joint(model, "Paralnk22_TrdPlate", ParaLnk22Mar2, Marker(TrdPlate90, "Trdplate_toParaLnk22", dxyz3,ref=secPmar2_90))
#
dxyz4= (L*gr*np.cos(d2r*(angleAlignedFromLevel2+angleFromAbligned2)),L*gr*np.sin(d2r*(angleAlignedFromLevel2+angleFromAbligned2)),0)
...
ParaLnk23Mar2=Marker(ParaLnk23, "ParaLnk23Mar2", dxyz4, ref=TrdPmar2)
...
ParaLnk24Mar2=Marker(ParaLnk24, "ParaLnk24Mar2", dxyz4, ref=ParaLnk24Mar1)
...
FthPmar2=Marker(FthPlate, "FthPmar2", (0, -(effDist*gr), 0), ref=FthPmar1)
Joint(model, "Fthplate_lm12_DISK2", FthPmar2, lm12.distalmarFront)
FthPmar3=Marker(FthPlate, "FthPmar3", (effDist*gr/2,0, 0), ref=FthPmar2)
FthPmar4=Marker(FthPlate, "FthPmar4", (effDist*gr/2,0, 0), ref=FthPmar1)
...
FthPmar1_90=Marker(FthPlate90, "FthPmar1_90", (effDist*gr, 0, 0),  ref=FthPmar0_90)
...
FthPmar2_90=Marker(FthPlate90, "FthPmar2_90", (effDist*gr/2, 0, 0),  ref=FthPmar1_90)
FthPmar3_90=Marker(FthPlate90, "FthPmar3_90", (0, effDist*gr, 0),  ref=FthPmar2_90)
Plate(FthPlate90, "plate90", T, T, (FthPmar0_90, FthPmar1_90, FthPmar2_90, FthPmar3_90)) 
#
cen_mar=Marker(FthPlate90, "center_mar", (effDist*gr+T/2, effDist*gr/2, -R*gr/2), (0,-90,0), ref=FthPmar3)
cyn_mar=Marker(FthPlate90, "Cylinder_mar", (effDist*gr+T/2, effDist*gr/2*0, -R*gr/2), (0,-90,0), ref=FthPmar3)
Cylinder(FthPlate90, "cyn", T, effDist*gr, cyn_mar)
UpPlate_mar1=Marker(FthPlate90, "UpPlate_mar1", (0,0,0), (0, -90, 0), ref=FthPmar4)
UpPlate_mar2=Marker(FthPlate90, "UpPlate_mar2", (0,0,effDist*gr), (0, 0, 0), ref=cyn_mar)
...
DnPlate_mar2=Marker(FthPlate90, "DnPlate_mar2", (0,0,effDist*gr), (0, 0, 0), ref=cyn_mar)
...
lm13_basemar=Marker(FthPlate90, "lm13_basemar", (0, 0, effDist*gr/4*3), ref=cyn_mar)
lm13=SliderMechanismLean(model, "SLM13", dln, drn, Ln, Ln*0.3, Rn, lm13_basemar, 0, lm13_shift1, lm13_shift2,  quad=1, _motion=_motion[2])
#
Rn=R*gr
dln=dl*gr
drn=dr*gr
...
freelen=(L-effDist)*gr
SPDPT(model, "Spring411", lm14.shiftedmarFront, lm14.SpringMar, 7, 0, 0, freelen)  
#
...
#simcmd=simcmd+"\n"+"entity modify entity = .Robot.Last_Run new = .Robot.reducedT"
#simcmd=simcmd+"\n"+"entity attr entity_name=.Robot.Spring111 active=off dependents_active=off"
#simcmd=simcmd+"\n"+"entity attr entity_name=.Robot.Spring112 active=off dependents_active=off"
#simcmd=simcmd+"\n"+"entity attr entity_name=.Robot.Spring121 active=off dependents_active=off"
#simcmd=simcmd+"\nsimulation single reset\nsimulation single trans type= static initial_static=no end_time=5 number_of_steps=50"
#simcmd=simcmd+"\n"+"entity modify entity = .Robot.Last_Run new = .Robot.originalT"
